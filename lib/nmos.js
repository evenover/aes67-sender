...
function buildSDP() {
	var ptpEUI = nmosConfig.ptpMaster.replace(/:\d+$/, '').toUpperCase();
	return [
		'v=0',
		...
		'a=ptime:1',
		'a=mediaclk:direct=0',
		`a=ts-refclk:ptp=IEEE1588-2008:${ptpEUI}:${nmosConfig.ptpDomain}`,
		`a=source-filter: incl IN IP4 ${nmosConfig.multicastAddr} ${nmosConfig.addr}`,
		'a=sendonly',
		''
	].join('\r\n');
}
